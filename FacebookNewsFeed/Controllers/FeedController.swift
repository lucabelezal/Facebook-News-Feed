...
class FeedController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(FeedCell.self, forCellWithReuseIdentifier: FeedController.cellId)
    }
...
extension FeedController: UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return FeedController.posts.numberOfPosts()
    }
    
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let feedCell = collectionView.dequeueReusableCell(withReuseIdentifier: FeedController.cellId, for: indexPath) as! FeedCell
        
        feedCell.post = FeedController.posts[indexPath as NSIndexPath]
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if let statusText = FeedController.posts[indexPath as NSIndexPath].statusText {
